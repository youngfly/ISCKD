...
model = dict(
    type='DIS_SMOKE',
    tea_pretrained='/workspace/mmdetection3d-master/work_dirs/smoke102/epoch_72.pth',
    # todo student model
    backbone=dict(
        type='DLANet',
        depth=34,
    ...
    tea_model =dict(type='SMOKEMono3D',
        backbone=dict(
            type='DLANet',
            depth=60,
            in_channels=3,
            ...
            init_cfg=dict(
                type='Pretrained',
                checkpoint='/home/pretrained model/dla102-d94d9790.pth'
            )
        ),
        neck=dict(
            type='DLANeck',
