...
model = dict(
    type='DIS_PGD',
    tea_pretrained="/workspace/mmdetection3d-master/work_dirs/PGD_reg3.2/epoch_48.pth",
    # todo student model
    backbone=dict(
        type='RegNet',
        arch='regnetx_800mf',
        ...
        init_cfg=dict(
            type='Pretrained',
            checkpoint='/home/pretrained model/RegNetX-800MF.pth')
    ),
    neck=dict(
        type='FPN',
    ...
    backbone=dict(
        ...
        init_cfg=dict(
            type='Pretrained',
            checkpoint='/home/pretrained model/RegNetX-3.2GF.pth')
    ),
   neck=dict(
       type='FPN',
